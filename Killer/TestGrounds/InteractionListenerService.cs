...
using Interaction.TestingGrounds.Utilities;
using Discord.WebSocket;
using Interaction.TestingGrounds.Extensions;

namespace Interaction.TestingGrounds {
    ...
    public class InteractionListenerService : IInteractionListenerService {
        ...
        public InteractionListenerService(IServiceProvider services) {
            ...
            _discordSocketClient.InteractionCreated += Handler_ComponentInteraction;
